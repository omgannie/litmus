...
Genre.create(name: "Japanese", categories: ["j-dance", "j-pop", "j-rock"])
Genre.create(name: "Kids", categories: ["children", "disney"])
Genre.create(name: "Metal", categories: ["metal", "metal-misc", "metalcore"])
Genre.create(name: "Pop", categories: ["singer-songwriter", "dance", "indie-pop", "pop", "power-pop"])
Genre.create(name: "R-n-B", categories: ["disco", "funk", "hip-hop", "r-n-b", "soul"])
Genre.create(name: "Rock", categories: ["alternative", "rock", "rock-n-roll", "indie", "hard-rock"])
Genre.create(name: "Latin", categories: ["latin", "latino", "spanish", "salsa", "samba"])
Genre.create(name: "Metal", categories: ["black-metal", "death-metal", "heavy-metal", "metal", "metal-misc"])
Genre.create(name: "Middle Eastern", categories: ["iranian", "turkish"])
Genre.create(name: "Punk", categories: ["punk", "punk-rock"])
Genre.create(name: "South American", categories: ["brazil", "latin", "latino", "salsa", "samba"])
Genre.create(name: "Reggae", categories: ["reggae", "reggaeton"])
Genre.create(name: "Techno", categories: ["detroit-techno", "minimal-techo", "techno"])
